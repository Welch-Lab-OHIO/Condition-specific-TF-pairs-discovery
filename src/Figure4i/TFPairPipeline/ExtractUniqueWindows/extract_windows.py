"""
====================================================================================================================
Python script name extract_windows.py
Script written by Liam Speakman

Date: July 14, 2025

This script takes in a contact file in the form "chrA:1-2 chrB:3-4" and produces a bed file with the present unique windows 

Usage example:
>>> python3 extract_windows.py S3.contacts.list S3.unique_windows.bed
...
if not len(sys.argv) == 3:
    ...
    exit(-1)
# Get specified piece of a window in the form chrA:1-2
